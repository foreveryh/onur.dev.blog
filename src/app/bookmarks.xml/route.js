...
export async function GET() {
  try {
    ...
    if (!bookmarks || bookmarks.length === 0) {
      return new Response(
        '<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Bookmarks unavailable</title></channel></rss>',
        {
    ...
    return new Response(
      '<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Bookmarks RSS Error</title></channel></rss>',
      {
        status: 500,
        headers: { 'Content-Type': 'application/rss+xml; charset=utf-8' }
      }
